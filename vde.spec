...
Summary(pl):	VDE: Wirtaulny Rozproszony Ethernet
Name:		vde
Version:	1.5.7
Release:	1
License:	GPL
...
Source0:	http://prdownloads.sourceforge.net/vde/%{name}-%{version}.tgz
...
%description -l pl
VDE: Wirtualny Rozproszony Ethernet. Narzêdzie to tworzy abstrakcyjny wirtualny ethernet.
